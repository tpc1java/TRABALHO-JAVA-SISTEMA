...
public class AcessoLaboratorioView {
	...
	public static void displayAcessoLaboratorioOptions() {
		while (true) {
			int option = 0;
			String optionStr = JOptionPane.showInputDialog("Acesso ao laboratorio\n" + "1. aluno\n" + "2. professor\n"
			...
			switch (option) {
			case 1:
				displayAutenticarAluno();
				break;
			case 2:
				displayAutenticarProfessor();
				break;
			default:
	...
	public static void displayAutenticarAluno() {
			...
			laboratorioRepositorio.autenticarAluno(idLaboratorioLong, aluno);
			JOptionPane.showMessageDialog(null, "Aluno " + idAluno + " autenticado com sucesso.");
			
	}

	public static void displayAutenticarProfessor() {
		RegistroRepositorio registroRepositorio = new RegistroRepositorio();
		LaboratorioRepositorio laboratorioRepositorio = new LaboratorioRepositorio(); 
		...
		laboratorioRepositorio.autenticarProfessor(idLaboratorioLong, professor);
		JOptionPane.showMessageDialog(null, "Professor " + idProfessor + " autenticado com sucesso.");
